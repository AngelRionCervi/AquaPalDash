...
<div class="range">
  ...
  <div class="range-input">
    <input bind:this={rangeInputMinEl} oninput={onRangeInput} type="range" class="min" {min} {max} value={defaultMin} {step} />
    <input bind:this={rangeInputMaxEl} oninput={onRangeInput} type="range" class="max" {min} {max} value={defaultMax} {step} />
  </div>
</div>
